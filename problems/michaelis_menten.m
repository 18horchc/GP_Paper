% Michaelis-Menten GP: unconstrained vs bounds vs deriv-obs vs combined.
clear; clc; close all;
...
x_deriv = [0.05;0.09;1;1.5;1.9];
y_deriv = [20;20;0.3;0.3;0.3];
...
y_max = Vmax;
epsilon = max(2 * noise_sd_true, 0.02);
...
%% Plot unconstrained vs bound-constrained vs derivative-obs vs combined GP
k_plot = 2;
